 ...
 * 
 * 
 * @description An svg first creative coding library based on LN a go library
 * These are all the things you should need to start drawing stuff. {@link ./Scene.js }
 * 
